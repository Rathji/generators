  ...
  render({ hub }) {
    ...
    function renderReference() {
      ...
      for (const reference of records) {
        ...
        if (canFetch) {
          const fetchBtn = el("button.pu-btn.secondary", { type: "button", text: "Fetch from owner" });
