...
export const identityView = {
  ...
  render({ hub }) {
    ...
    const reseedBtn = el("button.pu-btn.secondary", { type: "button", text: "Re-run demo import" });
    ...
    const resetBtn = confirmButton(el("button.pu-btn.secondary", { type: "button", text: "Reset hub data" }), "Reset hub data", async () => {
      await hub.resetData();
