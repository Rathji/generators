  ...
  render({ hub }) {
    ...
    function buildOpen() {
      ...
      for (const record of records) {
        ...
        const fixBtn = el("button.pu-btn.secondary", { type: "button", text: "Queue & run fix" });
    ...
    function buildAlerts() {
      ...
      for (const alert of alerts) {
        ...
        if (alert.status !== "acknowledged") {
          const ackBtn = el("button.pu-btn.secondary", { type: "button", text: "Acknowledge" });
    ...
    const scanBtn = el("button.pu-btn", { type: "button", text: "Scan now" });
