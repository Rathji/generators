...
Integrate-U is the *hub*. The tools it integrates — IT-U, CRM-U, PSA-U, RMM-U
...
- **By forking Integrate-U** — only if you want a member that already contains
...
In Integrate-U's `src/core/catalog.js`, add an entry to `CONNECTORS`:
