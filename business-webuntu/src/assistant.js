...
(function () {
  ...
  const APP_IDS = "assistant, file-manager, browser, terminal, notes, settings, software-center, system-monitor, calculator, image-viewer, pdf-viewer, text-editor, chat, weather, mail, easy-uploads, github, ai-images, the-ledger, project-master, atomic-roadmap, todo-checklist, file-format-converter, chance-code, perch-edit, diagram-it, sys-plan, ai-voice-assistant, voice-assistant, business-intelligence-dashboard, business-crm, business-documentation, business-psa";

  const SYSTEM_PROMPT =
"You are the Business Assistant, built into Webuntu Business OS — a fictional " +
"Debian-inspired business desktop (Webuntu Business 12, \"Iron Ledger\") that " +
"runs entirely in the browser on Perchance. It ships with an embedded suite of " +
"Perchance productivity apps: The Ledger (bookkeeping), Project Master " +
"(projects/tasks/kanban), Atomic Roadmap (AI backlogs), sys-plan and Diagram It " +
"(boards & diagrams), Todo Checklist, File Format Converter, Chance Code and " +
"Perch Edit (code), plus AI/voice assistants. You help with planning, finance, " +
"writing, code and using the OS itself. " +
...
"Example: [[ACTION]]launch|the-ledger[[/ACTION]]\n\n" +
"Available tools:\n" +
"  launch|<appId>            — open an installed OS app. Installed app ids: " + APP_IDS + ".\n" +
"  read|<path>               — read a text file (full path like /home/user/Documents/About Webuntu Business.txt). The file content will be handed back to you.\n" +
...
"chance to react, so do not pretend to know the outcome of an action in advance.";
  ...
  const QUICK_CHIPS = [
    ...
    { label: "💰 Open The Ledger", text: "Open The Ledger" },
    { label: "🗂️ List my Projects", text: "List my Projects folder" },
    { label: "📄 Summarize my Documents", text: "Read each file in my Documents folder and summarize it" },
    { label: "🔎 Find a planning tool", text: "Search the Software Center for planning" },
  ...
  function speakReply(text) {
    ...
    if (!clean) return;
    try {
      const p = root.voiceTools(clean, { queue: true, onError: () => {} });
      if (p && typeof p.catch === "function") p.catch(() => {}); // speech failures must never surface as unhandled rejections
    } catch (e) {}
  }
