...
(function () {
  ...
  const START_LINKS = [
    { slug: "the-ledger", icon: "🧾", label: "The Ledger", sub: "Books & invoices" },
    { slug: "project-master", icon: "📋", label: "Project Master", sub: "Projects & releases" },
    { slug: "atomic-roadmap", icon: "🗺️", label: "Atomic Roadmap", sub: "AI task planning" },
    { slug: "sys-plan", icon: "🧲", label: "sys-plan", sub: "System boards" },
    { slug: "diagram-it", icon: "📐", label: "Diagram It", sub: "IT diagrams" },
    { slug: "todo-checklist", icon: "✅", label: "Todo Checklist", sub: "Daily checklists" },
    { slug: "file-format-converter", icon: "🔁", label: "File Format Converter", sub: "Convert anything" },
    { slug: "chance-code", icon: "💻", label: "Chance Code", sub: "Perchance IDE" },
    { slug: "perch-edit", icon: "⌨️", label: "Perch Edit", sub: "Code editor for Perchance" },
    { slug: "ai-voice-assistant", icon: "🗣️", label: "AI Voice Assistant", sub: "Voice to-do lists" },
    { slug: "voice-assistant", icon: "🎙️", label: "Voice Assistant", sub: "Voice commands" },
