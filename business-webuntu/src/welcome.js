...
(function () {
  ...
  function buildTips() {
    ...
    const tips = [
      ...
      ["🧾", "The Ledger, Project Master and Atomic Roadmap are pre-installed under Finance & Planning."],
      ["🧩", "Software Center opens more Perchance generators for your stack."],
      ["🧠", "Business Assistant can open apps, read files and draft documents — press Super+A."],
    ];
  ...
  function build() {
    ...
    card.appendChild(el("h1", "wel-title", "Welcome to Webuntu Business"));
    card.appendChild(el("p", "wel-codename", "“Iron Ledger” · The Business Perch Desktop"));

    card.appendChild(el("p", "wel-intro",
      "Your browser-based business desktop is ready: an embedded Perchance suite for books, projects, roadmaps, diagrams and code — all on one desktop."));
