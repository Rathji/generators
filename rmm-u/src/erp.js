...
(function () {
  ...
  const ICONS = {
    ...
    devices: '<rect x="2" y="4" width="20" height="13" rx="2"/><path d="M8 21h8"/><path d="M12 17v4"/><path d="m8.5 10.5 1.5 1.5 3-3"/>',
    groups: '<polygon points="12 2 2 7 12 12 22 7 12 2"/><polyline points="2 17 12 22 22 17"/><polyline points="2 12 12 17 22 12"/>',
    policies: '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="m9 15 2 2 4-4"/>',
    ...
    patches: '<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/>',
    software: '<path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/>',
  ...
  ERP.states = {
    ...
    error(el, opts) {
      ...
      el.innerHTML =
        ...
        '<div class="erp-state-icon err">' + ERP.icon("alerts", 26) + "</div>" +
  ...
  const GROUPS = [
    ...
    { key: "monitoring", label: "Monitoring & response" },
  ...
  function setTitle(module) {
    ...
    document.title = (module ? module.label + " · " : "") + "RMM-U";
  }
  ...
  function boot() {
    ...
    if (brand) brand.textContent = configVal("branding.companyName", "RMM-U");
    const mark = $("#logoMark");
    if (mark) mark.textContent = configVal("branding.logoGlyph", "R").slice(0, 2);
