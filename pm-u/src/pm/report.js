...
import { openModal, toast, appTitle } from "./ui.js";
...
const reportPersona = () => `You are the weekly-summariser built into "${appTitle()}", a local-first project management app. The user asked for their weekly report. Using ONLY the workspace snapshot in <DATA> below, write a warm, honest, concrete summary of their week.
