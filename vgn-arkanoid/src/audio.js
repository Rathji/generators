...
const SFX = {
  ...
  // -- deeper Arkanoid -- lasers, bomb chain reactions, sticky catch --
  laser: { type: 'square', vol: 0.06, notes: [
    { f: 1500, d: 0.07, f2: 900 }, { f: 2200, t: 0.05, d: 0.06, f2: 1400 } ] },
  boom: { type: 'sawtooth', vol: 0.11, notes: [ { f: 180, d: 0.3, f2: 40 } ] },
  catch: { type: 'square', vol: 0.08, notes: [
    { f: 523.25, d: 0.05 }, { f: 392, t: 0.06, d: 0.12, f2: 330 } ] },
};
