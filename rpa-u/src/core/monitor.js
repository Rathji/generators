...
const BASELINE_LATENCY = { "crm-u": 118, "psa-u": 205, "it-u": 262, "rmm-u": 92, ru: 3, openrpa: 134 };
...
export function createMonitor({
  ...
  function recordError({ key = null, category = "sync", severity = "warning", title, detail = "", at = null, source = "ru", connector = null, refs = [] } = {}) {
  ...
  if (bus && typeof bus.subscribe === "function") {
    bus.subscribe("sync.*", (event) => observe(event), { label: "monitor", connector: "ru", priority: -10 });
  }
