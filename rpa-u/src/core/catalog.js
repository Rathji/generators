import { OPENRPA_DESCRIPTOR, OPENRPA_OPENFLOW_ROLE_MAP } from "./openrpa/constants.js";
import { OPENRPA_FIELD_MODEL, OPENRPA_OWNED_TYPES } from "./openrpa/ownership.js";
...
const BASE_FIELD_MODEL = {
  company: [
    ...
    { key: "accountNotes", label: "Internal account notes", owner: "ru", authoritative: true, direction: "none" },
  ],
  customer: [
...
export const FIELD_MODEL = Object.fromEntries(
  Object.entries(BASE_FIELD_MODEL).map(([typeId, fields]) => [
    typeId,
    [...fields, ...(OPENRPA_OWNED_TYPES.includes(typeId) ? OPENRPA_FIELD_MODEL[typeId] : []).map((field) => ({ ...field }))],
  ])
);
...
export const TOOL_ROLE_MAPS = {
  ...
  openrpa: OPENRPA_OPENFLOW_ROLE_MAP,
};
