import { OPENRPA_EVENT_TYPES } from "./openrpa/taxonomy.js";
...
export const EVENT_TYPES = [
  ...
  {
    type: "workflow.invoked",
    version: EVENT_VERSION,
    category: "automation",
    summary: "An OpenFlow workflow invocation was dispatched and is awaiting completion.",
    payload: {
      type: "object",
      fields: {
  ...
  },
  {
    ...
    version: EVENT_VERSION,
    category: "automation",
    summary: "An invoked OpenFlow workflow finished successfully.",
    payload: {
      type: "object",
      fields: {
        correlationId: { type: "string", required: true },
  ...
  },
  {
    ...
    version: EVENT_VERSION,
    category: "automation",
    summary: "An invoked OpenFlow workflow failed or timed out.",
    payload: {
      type: "object",
      fields: {
        correlationId: { type: "string", required: true },
