...
suite("Help & guides", () => {
  ...
  test("the help view presents the quick start, index, guides, glossary and about", () => {
    ...
    for (const heading of ["New here?", "What each screen is for", "Step-by-step guides", "Key concepts", "About RPA-U"]) {
    ...
    assert(text.includes("RPA-U"), "Help view should name the product");
  });
});
