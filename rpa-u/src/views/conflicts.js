  ...
  render({ hub }) {
    ...
    function buildSimulator() {
      ...
      function syncHint() {
        ...
        const writer = connectors.find((id) => id !== (field?.owner || "") && id !== "ru") || "ru";
      ...
      const writeBtn = el("button.pu-btn", { type: "button", text: "Write from another tool", style: { "margin-top": "0.75rem" }, "data-permission": "conflicts.resolve", "data-mutating": "" });
    ...
    function buildOpen() {
      ...
      if (decisions.length) {
        const resolveAllBtn = el("button.pu-btn.secondary", { type: "button", text: "Resolve all automatic", style: { "margin-top": "0.6rem" }, "data-permission": "conflicts.resolve", "data-mutating": "" });
      ...
      for (const decision of decisions) {
        ...
        const resolveBtn = el("button.pu-btn.secondary", { type: "button", text: `Adopt “${decision.value}”`, "data-permission": "conflicts.resolve", "data-mutating": "" });
