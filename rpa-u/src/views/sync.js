...
export const syncView = {
  ...
  render({ hub }) {
    ...
    function buildForm() {
      ...
      const queueBtn = el("button.pu-btn", { type: "button", text: "Queue job", "data-permission": "sync.run", "data-mutating": "" });
    ...
    function buildQueue() {
      ...
      const runAllBtn = el("button.pu-btn", { type: "button", text: "Run pending", "data-permission": "sync.run", "data-mutating": "" });
