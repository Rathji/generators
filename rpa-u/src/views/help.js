...
function quickStartCard() {
  ...
  card.appendChild(el("p.pu-small.pu-muted", { text: "RPA-U ships with a realistic demo directory. Re-run or reset it from the Canonical identity screen at any time." }));
  return card;
}
