...
export const eventsView = {
  ...
  render({ hub, onDestroy }) {
    ...
    function buildPublishCard() {
      ...
      const publishBtn = el("button.pu-btn", { type: "button", text: "Publish", "data-permission": "events.run", "data-mutating": "" });
    ...
    function buildSubscriptionCard() {
      ...
      const registerBtn = el("button.pu-btn", { type: "button", text: "Register subscription", "data-permission": "events.manage", "data-mutating": "" });
