...
// assets.ts
// NOTE (openciv port): URLs are relative to the generator page root. The bundle lives in
// src/game.js and the images in src/assets/, so "./src/assets/..." resolves correctly.
