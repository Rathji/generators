// Vendored from npm package `ts-priority-queue@0.1.1` (MIT) so no node_modules are needed.
// See https://github.com/... original sources live at src/PriorityQueue.ts + BinaryHeapStrategy.ts.
