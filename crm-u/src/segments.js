window.CRM_SEGMENTS = (function () {
  ...
  const FIELD_DEFS = {
    ...
    services: [
      { f: "category", label: "Service category", type: "string", options: ["internet", "voip", "sip-trunk", "managed-it", "cloud", "colocation", "mobile", "hardware", "other"] },
      { f: "status", label: "Status", type: "string", options: ["prospect", "pending", "active", "suspended", "terminated"] },
      { f: "companyId", label: "Linked to a company", type: "is" },
      { f: "siteId", label: "Linked to a site", type: "is" },
      { f: "charge", label: "Recurring charge ($)", type: "num" },
      { f: "billingCycle", label: "Billing cycle", type: "string", options: ["monthly", "quarterly", "semiannual", "annual"] },
      { f: "setupFee", label: "One-time / setup fee ($)", type: "num" },
      { f: "contractTermMonths", label: "Contract term (months)", type: "num" },
      { f: "bandwidth", label: "Bandwidth (Mbps)", type: "num" },
      { f: "quantity", label: "Seats / lines / channels", type: "num" },
      { f: "autoRenew", label: "Auto-renews", type: "bool" },
      { f: "circuitId", label: "Circuit id", type: "is" },
      { f: "owner", label: "Owner", type: "string" },
      { f: "tags", label: "Tag", type: "tag" },
      { f: "daysUntilRenewal", label: "Days until renewal", type: "num", hint: "e.g. ≤ 60 for services renewing inside two months" },
      { f: "daysSinceCreated", label: "Days since created", type: "num" },
      { f: "daysSinceLastActivity", label: "Days since last activity", type: "num" },
      { f: "custom", label: "Custom field…", type: "custom" }
    ],
    sites: [
      { f: "siteType", label: "Site type", type: "string", options: ["hq", "branch", "datacenter", "colo", "tower", "premises", "warehouse", "other"] },
      { f: "status", label: "Status", type: "string", options: ["active", "planned", "closed"] },
      { f: "companyId", label: "Linked to a company", type: "is" },
      { f: "siteCode", label: "Site code", type: "is" },
      { f: "timezone", label: "Timezone", type: "string" },
      { f: "owner", label: "Owner", type: "string" },
      { f: "tags", label: "Tag", type: "tag" },
      { f: "daysSinceCreated", label: "Days since created", type: "num" },
      { f: "daysSinceLastActivity", label: "Days since last activity", type: "num" },
    ...
    assets: [
      { f: "kind", label: "Asset kind", type: "string", options: ["did", "circuit", "ip-block", "cpe", "sim", "license", "other"] },
      { f: "status", label: "Status", type: "string", options: ["available", "assigned", "reserved", "in-repair", "retired"] },
      { f: "companyId", label: "Linked to a company", type: "is" },
      { f: "siteId", label: "Linked to a site", type: "is" },
      { f: "serviceId", label: "Linked to a service", type: "is" },
      { f: "identifier", label: "Identifier", type: "string" },
      { f: "serial", label: "Serial number", type: "string" },
      { f: "mac", label: "MAC address", type: "string" },
      { f: "msisdn", label: "MSISDN", type: "string" },
      { f: "provider", label: "Carrier / provider", type: "string" },
      { f: "owner", label: "Owner", type: "string" },
      { f: "tags", label: "Tag", type: "tag" },
      { f: "daysUntilWarranty", label: "Days until warranty end", type: "num", hint: "negative once expired; e.g. ≤ 30 for cover ending soon" },
      { f: "daysSinceCreated", label: "Days since created", type: "num" },
      { f: "custom", label: "Custom field…", type: "custom" }
    ],
    tickets: [
      { f: "status", label: "Status", type: "string", options: ["new", "open", "pending", "hold", "resolved", "closed"] },
      { f: "priority", label: "Priority", type: "string", options: ["urgent", "high", "medium", "low"] },
      { f: "category", label: "Category", type: "string", options: ["incident", "request", "change", "problem", "maintenance", "billing", "other"] },
      { f: "source", label: "Source", type: "string", options: ["phone", "email", "portal", "monitoring", "chat", "walk-in", "other"] },
      { f: "assignee", label: "Assignee", type: "string" },
      { f: "companyId", label: "Linked to a company", type: "is" },
      { f: "serviceId", label: "Linked to a service", type: "is" },
      { f: "siteId", label: "Linked to a site", type: "is" },
      { f: "assetId", label: "Linked to an asset", type: "is" },
      { f: "tags", label: "Tag", type: "tag" },
      { f: "slaMinutesLeft", label: "Minutes until SLA resolve", type: "num", hint: "negative when the SLA is already breached" },
      { f: "daysOpen", label: "Days open", type: "num" },
      { f: "daysSinceCreated", label: "Days since created", type: "num" },
      { f: "daysSinceLastActivity", label: "Days since last activity", type: "num" },
      { f: "custom", label: "Custom field…", type: "custom" }
    ],
    documents: [
      { f: "type", label: "Document type", type: "string", options: ["contract", "sla", "msa", "quote", "order", "licence", "invoice", "other"] },
      { f: "status", label: "Status", type: "string", options: ["draft", "active", "superseded", "archived"] },
      { f: "ownerType", label: "Owner type", type: "string", options: ["company", "contact", "service", "site", "asset"] },
      { f: "ownerId", label: "Linked to a record", type: "is" },
      { f: "companyId", label: "Linked to a company", type: "is" },
      { f: "reference", label: "Reference / number", type: "string" },
      { f: "value", label: "Contract value ($)", type: "num" },
      { f: "tags", label: "Tag", type: "tag" },
      { f: "daysUntilExpiry", label: "Days until expiry", type: "num", hint: "negative once expired; e.g. ≤ 60 for documents expiring inside two months" },
      { f: "daysSinceCreated", label: "Days since created", type: "num" },
      { f: "custom", label: "Custom field…", type: "custom" }
    ]
  };
  ...
  function dayDelta(rec, f) {
    ...
    if (f === "daysUntilRenewal") {
      const D = window.CRM_DOMAIN;
      if (D && typeof D.daysUntilRenewal === "function") return D.daysUntilRenewal(rec);
      return null;
    }
    if (f === "daysUntilWarranty") {
      const D = window.CRM_DOMAIN;
      if (D && typeof D.daysUntilDate === "function") return D.daysUntilDate(rec && rec.warrantyEnd);
      return null;
    }
    if (f === "daysUntilExpiry") {
      const D = window.CRM_DOMAIN;
      if (D && typeof D.daysUntilDocExpiry === "function") return D.daysUntilDocExpiry(rec);
      return null;
    }
    if (f === "slaMinutesLeft") {
      const D = window.CRM_DOMAIN;
      if (D && typeof D.ticketSlaState === "function") return D.ticketSlaState(rec).resolveMinutesLeft;
      return null;
    }
    if (f === "daysOpen") return daysSince(dateMs(rec && (rec.openedAt || rec.createdAt)));
